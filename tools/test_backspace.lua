...
io.open = function(path, mode)
    local text
    if path == repo.."/tiger_sentence.codes.txt" then text=entries
    elseif path == repo.."/tiger_sentence.char_ranks.txt" then text="甲\n乙\n是\n好\n我\n你\n𠀀\n"
    elseif path == repo.."/tiger_sentence.full_code_whitelist.txt" then text=""
    elseif path == repo.."/tiger_sentence.supplement.txt" then text="甲是\t1000\n" end
...
local oracle = dofile(os.getenv("TIGER_BACKSPACE_ORACLE") or repo.."/lua/tiger_sentence.lua")
